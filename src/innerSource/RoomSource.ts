export const roomSource: string = /* language=JavaScript */ `import {$, roomEmitter, getConnections} from "#inner";
...
export const roomInnerSource: string = /* language=JavaScript */ `import EventEmitter from "varhub:events";
export let $;
